    ...
    public partial class SignUpForm : Form
    {
        ...
        void CreateUser()
        {
            ...
            else
            {
                ...
                CloseCheck = true; //회원가입 폼을 강제종료하게될경우 메인폼이 종료되게끔 실행하는 폼 입니다.

                int ScoreClear = 0; // 점수는 0점으로 초기화 시켜줍니다.
                newUser.TesterName = IdInputText; // name 을 데이터베이스에 저장하는 코드입니다.
                newUser.TesterPassword = PswInputText; //비밀번호를 데이터베이스에 저장하는 코드입니다.
                newUser.TesterScore = ScoreClear; //최초의 점수 0 점을 저장하는 코드입니다.
                DataRepository.Tester.Insert(newUser); // 이름과 비밀번호 점수를 저장하도록 실행시켜주는 코드입니다.
            }
        }
